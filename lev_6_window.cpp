...
Lev_6_Window::Lev_6_Window(QWidget *parent) : QMainWindow(parent)
{
    ...
    Plitka[0]->hide();
    Plitka[1] = new Static_Object(":/res6/dedka.png", 200, 200, this);
    Plitka[1]->hide();
    Plitka[2] = new Static_Object(":/res6/babka.png", 200, 200, this);
    Plitka[2]->hide();
    Plitka[3] = new Static_Object(":/res6/babka.png", 200, 200, this);
    Plitka[3]->hide();
    Plitka[4] = new Static_Object(":/res6/vnuchka.png", 200, 200, this);
    Plitka[4]->hide();
    Plitka[5] = new Static_Object(":/res6/vnuchka.png", 200, 200, this);
    Plitka[5]->hide();
    Plitka[6] = new Static_Object(":/res6/zuchka.png", 200, 200, this);
    Plitka[6]->hide();
    Plitka[7] = new Static_Object(":/res6/zuchka.png", 200, 200, this);
    Plitka[7]->hide();
    Plitka[8] = new Static_Object(":/res6/koshka.png", 200, 200, this);
    Plitka[8]->hide();
    Plitka[9] = new Static_Object(":/res6/koshka.png", 200, 200, this);
    Plitka[9]->hide();
    Plitka[10] = new Static_Object(":/res6/myshka.png", 200, 200, this);
    Plitka[10]->hide();
    Plitka[11] = new Static_Object(":/res6/myshka.png", 200, 200, this);
    Plitka[11]->hide();
    Plitka[12] = new Static_Object(":/res6/repka.png", 200, 200, this);
    Plitka[12]->hide();
    Plitka[13] = new Static_Object(":/res6/repka.png", 200, 200, this);
    Plitka[13]->hide();
    Plitka[14] = new Static_Object(":/res6/tomat.png", 200, 200, this);
    Plitka[14]->hide();
    Plitka[15] = new Static_Object(":/res6/tomat.png", 200, 200, this);
    Plitka[15]->hide();
...
Lev_6_Window::~Lev_6_Window()
{
    ...
    delete Background;
    for(int i=0; i<16; ++i) delete Plitka_fon[i];
